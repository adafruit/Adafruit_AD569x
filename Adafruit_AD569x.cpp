 ...
 * 
 * @param newmode The new operating mode to set (from ad569x_operating_modes enum).
 ...
 */
bool Adafruit_AD569x::setMode(ad569x_operating_modes newmode, 
                              bool enable_ref, bool gain2x) {
...
bool Adafruit_AD569x::updateDAC(void) {
  // Prepare the command byte
  uint8_t command = ad569x_commands::UPDATE_DAC; // Assuming you've defined the enum as ad569x_commands
...
void Adafruit_AD569x::reset(void) {
  // Prepare the command byte
  uint8_t command = ad569x_commands::WRITE_CONTROL; // Assuming you've defined the enum as ad569x_commands
